...
const messageSchema = new Schema(
	{
		content: {
			...
			minlength: 1, // Minimum length can be set as per your requirement
		},
		chatImg: {
			type: String,
		},
		sender: {
			type: String, // Use ObjectId for better integrity
			ref: "User",
			required: true,
		},
		// receiver: {
		...
		readBy: [
			{
				type: String, // Store user IDs who have read the message
